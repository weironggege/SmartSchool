...
if __name__ == "__main__":
    ...
    # output_video_path = './jump4_out.mp4' 
    ...
    while True:
        ...
        if pose_landmarks is not None:
            ...
            y_r_h = person_left_heel[1]
            k,b = getlinepra([292,700], [178,920])
            l_x = (y_r_h - b) / k
            
            if person_left_heel[0] > l_x:
                s_dis = 0
            ...
            if person_left_heel[0] - l_x < 400:
                s_dis = round((l_x - person_left_heel[0]) / rotia, 2)
            
            print(l_x, person_left_heel)
            # S_dis = round((505 - person_left_heel[0]) / n_ratio, 2)

        cv2.line(output_frame, (x1,y1), (x2,y2), (255,0,0), thickness=2, lineType=4)
        #for li in list(range(0,301,15)):
        #    cv2.line(output_frame, (450-li,250), (480-li, 320), (255,255,255), thickness=2, lineType=4)

        cv2.putText(output_frame, 'Score:' + str(s_dis), (800, 250), cv2.FONT_HERSHEY_SIMPLEX, 1, (128, 0, 128), 4)
