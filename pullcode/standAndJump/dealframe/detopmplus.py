...
if __name__ == "__main__":
    ...
    while True:
        ...
        if pose_landmarks is not None:
            ...
            l_s_p, l_l_p, n_p, h_p = pose_landmarks[11], pose_landmarks[13], (pose_landmarks[11] +  pose_landmarks[12]) * 0.5, (pose_landmarks[23] +  pose_landmarks[24]) * 0.5

            vic1, vic2, vic3 = (l_l_p[0]-l_s_p[0], l_l_p[1]-l_s_p[1]), (h_p[0]-n_p[0], h_p[1]-n_p[1]), (0, 1)
            ...
            r_h = pose_landmarks[29]

            del tem_o[0]

            tem_o.append(r_h)

            if (_is_pan(tem_o) and tem_o[0][0] < 1000) and isend:
                e_idx = i - 5
                isend = False
